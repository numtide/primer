...
*Primer is a Jekyll theme for GitHub Pages. This is a fork that changes the
CSS to use NumTide colors*
...
1. [Copy the original template](https://github.com/numtide/primer/blob/master/_layouts/default.html) from the theme's repository<br />(*Pro-tip: click "raw" to make copying easier*)
...
1. Clone down the theme's repository (`git clone https://github.com/numtide/primer`)
